...
const sourceData = [
	{ code: 'LU', valuec: 36.4, valuep: 13.3, namefr: 'Luxembourg', name: 'Luxembourg' },
	{ code: 'BE', valuec: 14.9, valuep: 7.3, namefr: 'Belgique', name: 'Belgium' },
	{ code: 'MT', valuec: 11.9, valuep: 3.6, namefr: 'Malte', name: 'Malta' },
	{ code: 'FI', valuec: 11.3, valuep: 7.1, namefr: 'Finlande', name: 'Finland' },
	{ code: 'EE', valuec: 11.3, valuep: 7.9, namefr: 'Estonie', name: 'Estonia' },
	{ code: 'AT', valuec: 10.2, valuep: 6.8, namefr: 'Autriche', name: 'Austria' },
	{ code: 'DE', valuec: 9.9, valuep: 7.7, namefr: 'Allemagne', name: 'Germany' },
	{ code: 'CZ', valuec: 9.7, valuep: 8.2, namefr: 'République Tchèque', name: 'Czech Republic' },
	{ code: 'SI', valuec: 8.9, valuep: 6, namefr: 'Slovénie', name: 'Slovenia' },
	{ code: 'NL', valuec: 8.7, valuep: 8.1, namefr: 'Pays-Bas', name: 'Netherlands' },
	{ code: 'IE', valuec: 8.4, valuep: 6.8, namefr: 'Irlande', name: 'Ireland' },
	{ code: 'SK', valuec: 8.4, valuep: 5.6, namefr: 'Slovaquie', name: 'Slovakia' },
	{ code: 'DK', valuec: 8.3, valuep: 4.5, namefr: 'Danemark', name: 'Denmark' },
	{ code: 'LT', valuec: 7.8, valuep: 5, namefr: 'Lituanie', name: 'Lithuania' },
	{ code: 'PL', valuec: 7.5, valuep: 7.9, namefr: 'Pologne', name: 'Poland' },
	{ code: 'IT', valuec: 7.4, valuep: 5, namefr: 'Italie', name: 'Italy' },
	{ code: 'SE', valuec: 6.8, valuep: 3.8, namefr: 'Suède', name: 'Sweden' },
	{ code: 'HU', valuec: 6.8, valuep: 5, namefr: 'Hongrie', name: 'Hungary' },
	{ code: 'LV', valuec: 6.6, valuep: 3.6, namefr: 'Lettonie', name: 'Latvia' },
	{ code: 'CY', valuec: 6.5, valuep: 5.4, namefr: 'Chypre', name: 'Cyprus' },
	{ code: 'FR', valuec: 6.5, valuep: 4.2, namefr: 'France', name: 'France' },
	{ code: 'ES', valuec: 5.8, valuep: 4.5, namefr: 'Espagne', name: 'Spain' },
	{ code: 'BG', valuec: 5.5, valuep: 5.3, namefr: 'Bulgarie', name: 'Bulgaria' },
	{ code: 'PT', valuec: 5.2, valuep: 3.9, namefr: 'Portugal', name: 'Portugal' },
	{ code: 'HR', valuec: 5.2, valuep: 4.1, namefr: 'Croatie', name: 'Croatia' },
	{ code: 'GR', valuec: 5.1, valuep: 5, namefr: 'Grèce', name: 'Greece' },
	{ code: 'RO', valuec: 4, valuep: 3.7, namefr: 'Roumanie', name: 'Romania' }
];
